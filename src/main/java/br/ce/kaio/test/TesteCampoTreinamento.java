...
public class TesteCampoTreinamento {
	...
	public void testTextFieldDuplo(){
		dsl.escrever("elementosForm:nome", "Kaio");
		Assert.assertEquals("Kaio", dsl.obterValorCampo("elementosForm:nome"));
		dsl.escrever("elementosForm:nome", "Dolfini");
		Assert.assertEquals("Dolfini", dsl.obterValorCampo("elementosForm:nome"));
	}
